...
\begin{figure}[h] 
\centering
\includegraphics[width=0.65\textwidth]{1x1conv.png}
...
\begin{figure}[h] 
\centering
\includegraphics[width=0.9\textwidth]{inception.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{FCvsGAP.png}
...
\begin{figure}[tb] 
\centering
\includegraphics[width=0.9\textwidth, height=0.99\textheight, keepaspectratio]{GoogLeNet.png}
\caption{Architettura di GoogLeNet}
\label{fig:googlenet}
\end{figure}
